...
using Tyuiu.SamarAA.Sprint1.Task1.V4.Lib;

namespace Tyuiu.SamarAA.Sprint1.Task1.V4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* вычисляет результат по формуле ( x + y ) / x * y и печатает его на      *");
